...
public class PrismSocial : MonoBehaviour
{
    private Dictionary<Guid, int> relationships = new();
    ...
    public void Socialize(PrismCore otherPrism)
    {
        // brig myers
    ...
    public void Breed(PrismCore parent, bool isRandom = false)
    {
